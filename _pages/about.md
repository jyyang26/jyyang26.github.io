...
My research story revolves around **the Underlying Principles and Understanding of LLMs**, particularly focusing on how to enhance the **"Robustness"** and **"Safety"** of LLM-generated information, which connects to related areas such as **Trustworthy LLM** [**[PrivacyRestore<em>(ACL 2025 Main)</em>](https://arxiv.org/abs/2406.01394)**, **[RewardDS<em>(EMNLP 2025 Main)</em>](https://arxiv.org/abs/2502.18517)**], **Reasoning Model Merging** [**[RCP-Merging<em>(AAAI 2026)</em>](https://arxiv.org/abs/2508.03140)**,**[ReasonAny](https://arxiv.org/abs/2601.05560)**] and **Malicious Attacks** [**[PrivacyRestore<em>(ACL 2025 Main)</em>](https://arxiv.org/abs/2406.01394)**], of LLMs and so on:
...
<div style="max-height: 350px; overflow-y: auto;">
  <ul>
    ...
    <li>
      [2025.05] 🎉🎉 <strong>Co-First-Author paper</strong> <a href="https://arxiv.org/abs/2406.01394" style="text-decoration: underline; color: #52ADC8;"><strong>PrivacyRestore</strong></a> has been accepted to <strong>ACL 2025 Main</strong>! Deeply grateful to my mentor Ziqian and collaborator Jianwei! See you in Vienna!
    </li>
    <li>
